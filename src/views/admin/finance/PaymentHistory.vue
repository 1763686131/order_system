...
.payment-modal{display:flex;width:min(1040px,calc(100vw - 32px));max-height:min(900px,calc(100vh - 32px));flex-direction:column;overflow:hidden;color:#172033;background:#f4f7f9;border:1px solid #dfe5ec;border-radius:8px;box-shadow:0 24px 70px rgba(15,23,42,.24)}
...
@media(max-width:780px){.records-toolbar,.store-filter-area{align-items:stretch}.store-filter-area{flex-direction:column}.toolbar-actions{width:100%;justify-content:space-between}.table-footer{align-items:flex-start;flex-direction:column}.pagination{align-self:flex-end}.modal-overlay{padding:0}.payment-modal{width:100vw;height:100vh;max-height:100vh;border:0;border-radius:0}.basic-grid,.payment-grid,.other-grid,.account-preview{grid-template-columns:1fr}.account-preview div{padding:0 0 10px;border-right:0;border-bottom:1px solid #e2e8f0}.modal-footer{align-items:stretch;flex-direction:column}.modal-actions{justify-content:flex-end}}
</style>
